...
import type { TranslationMode } from "#rf/types/config/translate"
import type { TransNode } from "#rf/types/dom"
import { resolveProviderConfig } from "#rf/utils/constants/feature-providers"
...
export async function translateNodesBilingualMode(
  ...
  try {
    ...
    if (virtualLayoutSource) {
      ...
      // Atomic paragraph mode must not insert virtual bilingual units mid-flow.
